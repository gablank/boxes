...
- Vendoring pins recipes, not all downloaded code: Oh My Zsh follows floating Git HEAD, the gcloud component installer fetches extra artifacts, and npm/editor extensions are unpinned. Review complete PKGBUILD assignments; never strip version/checksum lines as inherently safe. See `aur/README.md` and `SECURITY-REVIEW.md`.
